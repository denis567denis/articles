...
export class InsertMigrationDataToBd1730640317142 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`  
        ...
        ('super','super denis', 'babai@bk.ru'),  
        ('denis','denis', 'babai@bk.ru');
      `);

    await queryRunner.query(`  
        INSERT INTO user_entity (name, email, password) VALUES  
        ('denis','babai@bk.ru', 'denis:0f0db1da732529655a7ab7617633d5fc6ec55370db70cc4b5e79874f03cc17c24bc818bda2854bb73da34b50dfd46078dcc95bdd0548bbd7a486cda38314a3db');
      `);
  }
